...
const PropertyDetail: React.FC = () => {
  ...
  useEffect(() => {
    const fetchPropertyDetails = async () => {
      ...
      try {
        setLoading(true);
        const response = await propertyAPI.getProperty(id as string);
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="mt-4 md:mt-0">
              <span className="text-3xl font-bold text-gray-900 flex items-center">
                <FaEuroSign className="mr-1" /> {property.price.toLocaleString()}
              </span>
              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mt-2 ${getStatusBadgeClass(property.status)}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
              ...
              <div className="border-t border-gray-200">
                <dl>
                  <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 capitalize">{property.type}</dd>
                  </div>
                  ...
                  <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{property.area} m²</dd>
                  </div>
                  <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt className="text-sm font-medium text-gray-500">Energy Rating</dt>
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{property.energyRating}</dd>
                  </div>
                  <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt className="text-sm font-medium text-gray-500">Development</dt>
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{property.project.name}</dd>
                  </div>
                </dl>
              </div>
            </div>
            ...
            {property.floorPlan && (
              <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
                <div className="px-4 py-5 sm:px-6">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Floor Plan</h3>
                </div>
                <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
                  <img
          ...
          <div className="lg:col-span-1">
            <div className="bg-white shadow overflow-hidden sm:rounded-lg sticky top-8">
              ...
              <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
                ...
                <Link href="/property">
                  <button
                    className="mt-4 w-full bg-white border border-gray-300 rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  >
                    Back to Properties
                  </button>
                </Link>
